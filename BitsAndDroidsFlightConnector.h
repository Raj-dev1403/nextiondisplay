...
public:
  ...
  int getFCU_HEADING_KNOB_INC() { return FCU_HEADING_KNOB_INC; };
  ...
  int getOutput4001() { return output4001; }

  int getOutput4002() { return output4002; }

  int getOutput6011() { return output6011; }

  int getOutput1001() { return output1001; }

  int getOutput6010() { return output6010; }

  int getOutput4003() { return output4003; }

  int getOutput1000() { return output1000; }

  int getOutput6012() { return output6012; }
  // END GETTER TEMPLATE
